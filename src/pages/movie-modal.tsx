...
const MovieProduction = ({ movie }: { movie: MovieDetailsResponse }) => {
...
export const MovieModal: React.FC<{
  ...
  isOpen: boolean;
  onModalClose: () => void;
}> = ({ movie, isOpen, onModalClose, isTrendingMovie }) => {
    ...
    >
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-5 space-y-4 sm:space-y-5">
          ...
          {!isSharing && !isTrendingMovie && (
            <MovieWatchedFooter movie={movie} onClose={onModalClose} />
          )}

          {isTrendingMovie && (
            <MovieTrendingFooter movie={movie} onClose={onModalClose} />
          )}
        </div>
      </div>
    </div>
