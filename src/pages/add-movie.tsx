...
const Results: React.FC<{
  ...
  return (
    <div className="absolute z-20 top-full left-0 right-0 mt-2 max-h-[60vh] overflow-y-auto rounded-xl bg-tertiary border border-border-default shadow-2xl shadow-black/50">
      {!hasMovies && !hasTvs && (
